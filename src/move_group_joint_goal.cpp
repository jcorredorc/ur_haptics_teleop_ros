...
int main(int argc, char** argv)
{
  ...
  joint_group_positions[0] = tau / 4;  // tau / 4;  // -1/6 turn in radians
  ...
  visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to continue the demo, execute the planning ... ");
